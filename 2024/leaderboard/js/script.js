...
function readData() { 
  d3.csv("data/submissions2024.csv?t="+Date.now(), d3.autoType).then(function(data) {
...
function main() {
  ...
  d3.csv("data/droppedCandidates.csv?t="+Date.now()).then(function(droppedCandidatesList) {
